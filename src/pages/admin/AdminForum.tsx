...
const AdminForum = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      toast({
        title: "Erro",
        description: "Não foi possível carregar os dados do fórum.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Carregando fórum...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Fórum Administrativo</h1>
